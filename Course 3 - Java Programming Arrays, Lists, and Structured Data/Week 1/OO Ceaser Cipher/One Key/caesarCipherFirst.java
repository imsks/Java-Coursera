 ...
 */
import edu.duke.*;
public class caesarCipherFirst {
    ...
    public void tester(){
        ...
        */
        ...
        int key1 = 8;
        int key2 = 21;
        String encryptTwoKeys = encryptTwoKeys("At noon be in the conference room with your hat on for a surprise party. YELL LOUD!", key1, key2);
